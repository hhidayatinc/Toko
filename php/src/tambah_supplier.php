...
<html lang="en">
  ...
  if(isset($_POST["add"])){//jika tombol login di klik
    ...
    $sql="INSERT INTO supplier (nama,no_telp,alamat,email)
      VALUES('$nama','$no_telp','$alamat','$email')";
     if (mysqli_query($connect, $sql)){
        echo "<script> alert('Data berhasil ditambahkan!'); window.location.href='daftar_supplier.php'; </script>";?>
            
            <?php
        }else{
            echo "<script> alert('Data gagal ditambahkan!'); window.location.href='tambah_supplier.php'; </script>"; ?>
  ...
  <div class="container">
      <h2 style="margin-top: 50px;"> Tambah Supplier</h2>
